...
/*
 * `sortedValues` deve chegar já ordenado ascendentemente —
 * median/calculatePercentiles compartilham uma única ordenação
 * feita em summarizeDistribution() em vez de reordenar a cada
 * chamada de percentil.
 */
...
function median(
  ...
  return percentileFromSorted(sortedValues, 0.5);
}
...
function calculatePercentiles(
  ...
  return {
    ...
    p10: percentileFromSorted(sortedValues, 0.10),
    p25: percentileFromSorted(sortedValues, 0.25),
    p50: percentileFromSorted(sortedValues, 0.50),
    p75: percentileFromSorted(sortedValues, 0.75),
    p90: percentileFromSorted(sortedValues, 0.90),
